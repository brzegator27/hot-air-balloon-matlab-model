...
ro0 = 1.2; %gêstoœæ powietrz dla temp. 20 *C jednostka: kg / m^3
...
sprP = 0.4; %sprawnoœæ palnika podgrzewaj¹cego powietrze w balonie - wspó³czynnik
...
spadekTemp = 0.006; %Wspó³czynnik spadku temperatury w zale¿noœci od wysokoœci [ K / m ]
